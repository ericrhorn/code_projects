...
def get_default_profile_image():
    return "media/profile-picture.png"
...
class User(AbstractBaseUser):
    ...
    profile_img = models.ImageField(max_length=255, upload_to=get_profile_image_filepath, null=True, blank=True, default='profile-picture.png')
